...
t = os.path.exists('C:/Mantra/Reports/Pendingwriteoff.xlsx')
print(t)

if t:
    book=xlrd.open_workbook('C:/Mantra/Reports/PendingWriteoff.xlsx')
    sheet=book.sheet_by_index(0)
    nr= sheet.nrows
    print(nr)
    wb = load_workbook("C:/Mantra/Reports/PendingWriteoff.xlsx")
    ws = wb["Sheet"]
    row = nr + 1
...
wb.save("C:/Mantra/Reports/PendingWriteoff.xlsx")
