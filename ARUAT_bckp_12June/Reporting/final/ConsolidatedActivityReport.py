...
if curdate == '1':
    ...
    wb.save('C:/Users/consultants/Mantra/Consolidatedactivity/ConsolidatedActivityReport_'+dt+'.xlsx')

else:
    dt = (datetime.today()).strftime('%b%Y')
    print(dt)
    t = os.path.exists('C:/Mantra/Reports/Consolidatedactivity/ConsolidatedActivityReport_'+dt+'.xlsx')
    print(t)

    if t:
        book = xlrd.open_workbook('C:/Mantra/Reports/Consolidatedactivity/ConsolidatedActivityReport_'+dt+'.xlsx')
        sheet = book.sheet_by_index(0)
        nr = sheet.nrows
        print(nr)
        wb = load_workbook('C:/Mantra/Reports/Consolidatedactivity/ConsolidatedActivityReport_'+dt+'.xlsx')
        ws = wb["Sheet"]
        row = nr + 1
    ...
    for col in ws.columns:
        ...
        adjusted_width = (max_length + 2) * 1
        ws.column_dimensions[column].width = adjusted_width
    wb.save('C:/Mantra/Reports/Consolidatedactivity/ConsolidatedActivityReport_'+dt+'.xlsx')