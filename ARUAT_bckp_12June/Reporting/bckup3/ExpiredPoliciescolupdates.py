...
csr = conn.cursor()
csr.execute("Select Clientid,Clientname,PolicyNum,PremDue,EquityDate,Emailid,PhnNum1,PhnNum2,PhnNum3,Branch,ACCEXE from ae  where DTE between -30 and -1  and ReductionCheckBox = 0 order by Branch")
rcrds = csr.fetchall()
print(rcrds)
...
print(dt)
wb.save('C:/Mantra/Reports/updatedoutputs/Expiredpolicies' + '_' + dt + '.xlsx')
