...
csr = conn.cursor()
csr.execute("Select Clientid,Clientname,PolicyNum,PremDue,EquityDate,Emailid,PhnNum1,PhnNum2,PhnNum3,ACCEXE,Branch from ae  where DTE between -30 and -1  and ReductionCheckBox = 0 order by Branch")
rcrds = csr.fetchall()
print(rcrds)
...
csr = conn.cursor()
csr.execute("Select Clientid,Clientname,PolicyNum,PremDue,EquityDate,Emailid,PhnNum1,PhnNum2,PhnNum3,Branch from nonae where  DTE between -30 and -1 and ReductionCheckBox = 0 order by branch")
rcrds = csr.fetchall()
print(rcrds)
if AErecords == 0:
    row = 1
...
print(dt)
wb.save('C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/ExpiredPolicies/Expiredpolicies' + '_' + dt + '.xlsx')
