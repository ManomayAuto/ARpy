...
ws.cell(1,5).value =('Reduction Trans ID')
...
wb.save('C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/pendingwriteoff/''PendingWriteoff'+'_'+dt+'.xlsx')
