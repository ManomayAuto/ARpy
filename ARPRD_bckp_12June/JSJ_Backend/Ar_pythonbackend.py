    ...
    try:
        if request.method == "POST":
            ...
            for row in db1:
                ...
                smtpObj.login('ispaadmin@jsjemail.com', "46&@tEfL")
                msg = MIMEMultipart()
                msg['subject'] = "JSJ Account Security Details"
                msg['from'] = 'ispaadmin@jsjemail.com'
                msg['to'] = email
                msgtext1 = MIMEText(
                    '<p>Hi %s,</p>'
                ...
                msg.attach(msgtext1)
                smtpObj.sendmail('ispaadmin@jsjemail.com', email, msg.as_string())
            print("Emailsend")
...
@cross_origin(origins="http://192.193.194.127:4200", headers="*")
def ae():
    cur = conn.cursor()
    print("---------------------------------------------------------------")
...
def AEEscalation():
    ...
    wb.save('C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/TempFolder/''AEEscalationReport' + '_' + dt + '.xlsx')
...
def ConsolidatedActivityReport():
    ...
    print(dt)
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/ConsolidatedActivity/ConsolidatedActivityReport_'+dt+'.xlsx'
    print(file_name)
...
def ExpiredPolicies():
    ...
    dt = (datetime.today()).strftime('%d%b%y')
    print(dt)
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/TempFolder/Expiredpolicies' + '_' + dt + '.xlsx'
    print(file_name)
    wb.save(
        'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/TempFolder/Expiredpolicies_'+ dt + '.xlsx')
    return send_file(file_name)
...
def NONAEEscalation():
    ...
    dt = (datetime.today()).strftime('%d%b%y')
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/TempFolder/NONAEEscalationReport' + '_' + dt + '.xlsx'
    wb.save(
        'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/TempFolder/NONAEEscalationReport' + '_' + dt + '.xlsx')
    return send_file(file_name)
...
def PendingWriteoff():
    ...
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/pendingwriteoff/PendingWriteoff'+'_'+dt+'.xlsx'
    print(file_name)
...
def EmailFollowUps():
    ...
    dt =((datetime.today())).strftime('%d%b%y')
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/Emailfollowup/EmailFollowUps_'+dt+'.xlsx'
    print(file_name)
...
def InstalmentReminderFailedReport():
    ...
    dt =(datetime.today()).strftime('%d%b%y')
    file_name = 'C:/Users/administrator.JSJHO/Desktop/Consultant Files/Mantra/Instalmentreminder/InstalmentReminderFailedReport_'+dt+'.xlsx'
    print(file_name)
...
if __name__ == '__main__':
    ...
    app.debug = True
    app.run(host='192.193.194.127', port=5000)
